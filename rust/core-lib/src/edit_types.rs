...
pub(crate) enum ViewEvent {
    ...
    FindNext { wrap_around: Option<bool>, allow_same: Option<bool>, modify_selection: SelectionModifier },
    FindPrevious { wrap_around: Option<bool>, allow_same: Option<bool>, modify_selection: SelectionModifier },
    FindAll,
    Cancel,
